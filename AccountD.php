...
<span>Start Date<input type="date" class="form-control"></input></span>
    </div>
    <div class="form-group">
    <span>End Date<input type="date" class="form-control"></input><br/> <button class="btn btn-secondary">Search</button></span>
    </div>
    </div>
</form>
